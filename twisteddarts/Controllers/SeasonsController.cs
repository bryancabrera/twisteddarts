...
namespace TwistedDarts.Controllers
{
    public class SeasonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SeasonID,SeasonName,StartDate,EndDate")] Season season)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SeasonID,SeasonName,StartDate,EndDate")] Season season)
        {
            if (ModelState.IsValid)
            {
